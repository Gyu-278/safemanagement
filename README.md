...
# Content View
All the edition based on the file [ContentView.swift](https://github.com/KrystalZhang612/SimpleLoginScreen/blob/main/SimpleLoginScreen/ContentView.swift)<br/>
